...
@Data
@Entity
@Table(name = "informationstudent")
public class InformationStudent implements Serializable{
	
	@Id
	@SequenceGenerator(name = "seqstudent", initialValue = 20200001, allocationSize = 1)
	...
	public InformationStudent(String fullname, String piduser, Date birth, String phone, String mail, String country, String classroom) {
